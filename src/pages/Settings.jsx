...
const Settings = () => {
  ...
  const renderBody = (item, index) => (
    <tr key={index}>
      <td>{item.id}</td>
      <td>{item.URL}</td>
   <td><Badge type={orderStatus[item.attack_prediction]} content={orderStatus[item.attack_prediction]}/> </td>   
   <td>
      ...
      <Modal show={show} onHide={handleClose} animation={false}>
        <Modal.Header closeButton>
          <Modal.Title><h3>The Description of Attack Prediction</h3> </Modal.Title>
        </Modal.Header>
